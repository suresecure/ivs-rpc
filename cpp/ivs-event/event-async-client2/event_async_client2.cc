...
class EventReportingClient {
  public:
    ...
    void SayHello(const std::string& user) {
        ...
        call->response_reader = stub_->AsyncReportEvent(&call->context, request, &cq_);
  ...
  private:
    ...
    struct AsyncClientCall {
        ...
        std::unique_ptr<ClientAsyncResponseReader<ReportEventReply>> response_reader;
    };
...
int main(int argc, char** argv) {
    ...
    std::thread thread_ = std::thread(&EventReportingClient::AsyncCompleteRpc, &greeter);
