...
class ImageAnalysisClient {
  public:
    ...
    void ImageClassify(const ImageRegion& image_region) {
        ...
        call->response_reader = stub_->AsyncImageClassify(&call->context, image_region, &cq_);
  ...
  private:
    ...
    struct AsyncClientCall {
        ...
        std::unique_ptr<ClientAsyncResponseReader<ImageClassifyReply>> response_reader;
    };
...
int main(int argc, char** argv) {
    ...
    std::thread thread_ = std::thread(&ImageAnalysisClient::AsyncCompleteRpc, &greeter);
